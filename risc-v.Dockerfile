...
RUN wget -qO- https://buildbot.embecosm.com/job/riscv32-gcc-ubuntu2204-release/7/artifact/riscv32-embecosm-ubuntu2204-gcc12.3.0.tar.gz | tar -xz -C /opt

ENV PATH "/opt/riscv32-embecosm-ubuntu2204-gcc12.3.0/bin:$PATH"
